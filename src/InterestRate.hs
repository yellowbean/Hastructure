...
module InterestRate
  ...
  ,getRateResetDates,getDayCount,calcInt, calcIntRate,calcIntRateCurve, getSpread)
...
getSpread :: RateType -> Maybe Spread
getSpread (Fix _ _) = Nothing
getSpread (Floater _ _ spd _ _ _ _ _) = Just spd
