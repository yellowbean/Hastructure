...
import Debug.Trace
debug = flip trace
trs = [CF.MortgageFlow (L.toDate "20220101") 100 10 10 0 0 0 0
      , CF.MortgageFlow (L.toDate "20220201") 90 10 10 0 0 0 0
      , CF.MortgageFlow (L.toDate "20220211") 80 10 10 0 0 0 0
      , CF.MortgageFlow (L.toDate "20220301") 70 10 10 0 0 0 0]
  ...
  [
   ...
   ,testCase "Cashflow Aggregation agg correct amount" $
     assertEqual "which bal is 100"
       (CF.MortgageFlow (L.toDate "20220110") 100 10 10 0 0 0 0)
       (head aggTs1)
   ...
   ,testCase "Cashflow Aggregation agg correct amount" $
     assertEqual "which bal is 90"
       (CF.MortgageFlow (L.toDate "20220210") 90 20 20 0 0 0 0)
       (head aggTs2)
   ...
   ,testCase "Cashflow Aggregation agg correct amount" $
     assertEqual "which bal is 90"
        [CF.MortgageFlow (L.toDate "20220101") 100 10 10 0 0 0 0
        ,CF.MortgageFlow (L.toDate "20220208") 90 10 10 0 0 0 0]
        aggTs3

   ,testCase "Cashflow Aggregation with two flows at second cutoff" $
     assertEqual "include two cf in one cutoff date"
       [CF.MortgageFlow (L.toDate "20220101") 100 10 10 0 0 0 0
       ,CF.MortgageFlow (L.toDate "20220218") 80 20 20 0 0 0 0]
       aggTs4

   ,testCase "Get Latest Cashflow 1" $
     assertEqual "Found one"
       (Just $ CF.MortgageFlow (L.toDate "20220211") 80 10 10 0 0 0 0)
       --(Just $ CF.MortgageFlow (L.toDate "20220211") 80 10 10 0 0 0)
       findLatestCf1
   ,testCase "Get Latest Cashflow 2" $
     assertEqual "Found one"
       (Just (CF.MortgageFlow (L.toDate "20220301") 70 10 10 0 0 0 0))
       findLatestCf2
