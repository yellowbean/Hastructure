  ...
  [
   ...
   ,
    ...
    in
      ...
      assertEqual "Test Pricing on case 01" (B.PriceResult 504.9505 16.831684 0.25 1.0 ) pr
    ,
     let
     ...
     in
       ...
       assertEqual "Test Pricing on case 01" (B.PriceResult 816.1008 27.203362 0.043918636 0.18040144) pr
    ,
    let
